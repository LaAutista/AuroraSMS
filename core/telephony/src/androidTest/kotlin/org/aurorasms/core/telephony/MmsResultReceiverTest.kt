...
import org.aurorasms.core.telephony.receiver.transportOperationOrigin
...
class MmsResultReceiverTest {
    @Test
    fun outgoingComposerOriginRoundTripsThroughPrivateIntent() {
        val context = ApplicationProvider.getApplicationContext<Context>()
        val operation = MessageId(ProviderKind.PENDING_OPERATION, 91L)
        val uri = Uri.parse(
            "content://${context.packageName}.mms-pdu/mms_send/00000000-0000-0000-0000-000000000009.pdu",
        )

        val intent = MmsSendResultReceiver.createIntent(
            context,
            operation,
            uri,
        ...
        assertEquals(
            ...
            intent.transportOperationOrigin(),
        )
    }
