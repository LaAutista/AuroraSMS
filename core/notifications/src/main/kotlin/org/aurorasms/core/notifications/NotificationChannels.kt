...
object NotificationChannels {
    ...
    fun ensureCreated(context: Context) {
        // Android owns channel-level lock-screen overrides. AuroraSMS instead marks each
        // notification private and supplies a generic public version where content could leak.
